            ...
            <div className="col-lg-9 col-md-8 col-12">
              <div className="row mb-4">
                <h4 className="mb-0 mb-4">
                  {" "}
                  <i className="bi bi-grid-fill"></i> Дошка
                </h4>
                {/* Counter item */}
                ...
                <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                  <div className="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-10 rounded-3">
                    ...
                    <div className="ms-4">
                      ...
                      <p className="mb-0 h6 fw-light">Всього курсів</p>
                    </div>
                  </div>
                </div>
                {/* Counter item */}
                <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                  <div className="d-flex justify-content-center align-items-center p-4 bg-danger bg-opacity-10 rounded-3">
                    ...
                    <div className="ms-4">
                      ...
                      <p className="mb-0 h6 fw-light">Закінчено уроків</p>
                    </div>
                  </div>
                </div>
                {/* Counter item */}
                <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                  <div className="d-flex justify-content-center align-items-center p-4 bg-success bg-opacity-10 rounded-3">
                    ...
                    <div className="ms-4">
                      ...
                      <p className="mb-0 h6 fw-light">Отримано Сертифікатів</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {fetching === false && (
                <div className="card mb-4">
                  <div className="card-header">
                    <h3 className="mb-0">Курси</h3>
                    <span>
                      Почніть дивитися курси зараз зі сторінки вашої дошки.
                    </span>
                  </div>
                    ...
                    <form className="row gx-3">
                      <div className="col-lg-12 col-md-12 col-12 mb-lg-0 mb-2">
                        <input
                          ...
                          placeholder="Шукайте свої курси"
