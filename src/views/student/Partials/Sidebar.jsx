                    ...
                    <div className="navbar-nav flex-column">
                        <ul className="list-unstyled ms-n2 mb-4">
                            <li className="nav-item">
                                <Link className="nav-link" to={`/student/dashboard/`}> <i className='bi bi-grid-fill'></i> Дашборд</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`/student/courses/`}> <i className='fas fa-shopping-cart'></i> Мої Курси</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`/student/wishlist/`}>  <i className='fas fa-heart'></i> Обране </Link>
                            </li>
                        </ul>
                        ...
                        <ul className="list-unstyled ms-n2 mb-0">
                            <li className="nav-item">
                                <Link className="nav-link" to={`/student/profile/`}> <i className='fas fa-edit'></i> Редагувати профіль</Link>
                            </li>
                            <li className="nav-item ">
                                <Link className="nav-link" to={`/student/change-password/`}> <i className='fas fa-lock'></i> Змінити пароль</Link>
                            </li>
                            <li className="nav-item">
