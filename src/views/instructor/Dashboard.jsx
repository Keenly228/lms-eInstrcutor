            ...
            <div className="col-lg-9 col-md-8 col-12">
                ...
                <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                  <div className="d-flex justify-content-center align-items-center p-4 bg-danger bg-opacity-10 rounded-3">
                    ...
                    <div className="ms-4">
                      ...
                      <p className="mb-0 h6 fw-light">Всього Студентів</p>
                    </div>
                  </div>
                </div>
                {/* Counter item */}
                <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                  <div className="d-flex justify-content-center align-items-center p-4 bg-success bg-opacity-10 rounded-3">
                    ...
                    <div className="ms-4">
                      ...
                      <p className="mb-0 h6 fw-light">Загальний дохід</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card mb-4">
                <div className="card-header">
                  ...
                  <span>
                    Керуйте своїми курсами звідси, шукайте, переглядайте, редагуйте або видаляйте курси.
                  </span>
                </div>
