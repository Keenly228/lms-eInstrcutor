...
function CourseCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("File being sent:", variants[0].items[0].file);
    if (course.file !== null || course.file !== "") {
      formdata.append("file", course.file || "");
    }

    console.log(course.category);
    console.log("Data being sent to server:", { variants });
    console.log(variants[0].items[0].file);
                      ...
                      <div className="offset-lg-1 col-lg-10 col-md-12 col-12">
                        <div className="d-lg-flex align-items-center justify-content-between">
                          ...
                          <div className="mb-4 mb-lg-0">
                            <h1 className="text-white mb-1">Додати новий курс</h1>
                            <p className="mb-0 text-white lead">
                              Просто заповніть форму та створіть свої курси.
                            </p>
                          </div>
                          <div>
                            <Link
                            ...
                            >
                              {" "}
                              <i className="fas fa-arrow-left"></i> Назад до
                              курсів
                            </Link>
                            <a
                            ...
                            >
                              Зберегти <i className="fas fa-check-circle"></i>
                            </a>
                          </div>
                        </div>
                      </div>
                ...
                <section className="pb-8 mt-5">
                  <div className="card mb-3">
                    ...
                    <div className="card-header border-bottom px-4 py-3">
                      <h4 className="mb-0">Основна інформація</h4>
                    </div>
                    <div className="card-body">
                      ...
                      <div className="mb-3">
                        ...
                        />
                        <small>Напишіть назву курсу з 60 символів..</small>
                      </div>
                      <div className="mb-3">
                        <label className="form-label">Категорія курсів</label>
                        <select
                        ...
                        <small>
                          Допоможіть людям знайти ваші курси, вибравши категорії, які представляють ваш курс.
                        </small>
                      </div>
                      <div className="mb-3">
                        <select
                      ...
                      <div className="mb-3">
                        ...
                        />
                        <small>Короткий опис ваших курсів..</small>
                      </div>
                      <label htmlFor="courseTitle" className="form-label">
                        Ціна
                      </label>
                    ...
                    {/* Curriculum Section */}
                    <div className="card-header border-bottom px-4 py-3">
                      <h4 className="mb-0">Навчальний план</h4>
                    </div>
                    <div className="card-body ">
