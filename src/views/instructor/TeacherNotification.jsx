                            ...
                            <div className="card mb-4">
                                ...
                                <div className="card-header d-lg-flex align-items-center justify-content-between">
                                    <div className="mb-3 mb-lg-0">
                                        <h3 className="mb-0">Сповіщення</h3>
                                        <span>Керуйте всіма сповіщеннями тут</span>
                                    </div>
                                </div>
                                {/* Card body */}
                                                        ...
                                                        <div className="mt-2">
                                                            <p className="mt-1">
                                                                <span className="me-2 fw-bold">
                                                                    Дата: <span className="fw-light">{moment(n.date).format("DD MMM, YYYY")}</span>
                                                                </span>
                                                            </p>
                                                            <p>
                                                                <button class="btn btn-outline-secondary" type="button" onClick={() => handleMarkAsSeen(n.id)}>
                                                                    Позначити як прочитане <i className="fas fa-check"></i>
                                                                </button>
                                                            </p>
                                                        </div>
                                                    </div>
