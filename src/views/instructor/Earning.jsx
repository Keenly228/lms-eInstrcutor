...
function Earning() {
    ...
    useEffect(() => {
        console.log("User Data:", UserData()?.teacher_id);
                        ...
                        <div className="col-lg-9 col-md-8 col-12">
                            <div className="card mb-4">
                                <div className="card-body">
                                    <h3 className="mb-0">Доходи</h3>
                                    <p className="mb-0">Ви маєте повний контроль над налаштуваннями свого облікового запису.</p>
                                </div>
                            </div>
                            <div className="card mb-4">
                            ...
                            <div className="card mb-4">
                                <div className="card-header border-bottom-0">
                                    <h3 className="mb-0 h4">Лідери продажів</h3>
                                </div>
                                {/* Table */}
                            ...
                            <div className="card mb-4">
                                {/* Card header */}
                                <div className="card-header border-bottom-0">
                                    <h3 className="h4 mb-3">Історія доходів</h3>
                                </div>
                                {/* Table */}
                                <div className="table-responsive">
