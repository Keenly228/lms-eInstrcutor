        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 text-white">
            ...
            <div className="mb-4">
              ...
              <div className="mt-4">
                <p>
                  eInstructor is feature-rich components and beautifully Bootstrap UIKit
          ...
          <div className="col-lg-3 col-md-12">
            {/* contact info */}
            <div className="mb-4">
              <h3 className="fw-bold mb-3">Lviv Polytechnic</h3>
              <p>28a S. Bandera Street</p>
              <p className="mb-1">
                Email:
                <a href="#" className='text-white'> bohdan.barylo.mkisk.2023@lpnu.ua</a>
              </p>
              <p>
                Phone:
